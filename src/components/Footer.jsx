...
const Footer = () => {
  ...
  const techStack = [
    ...
    { icon: <SiNextdotjs className="text-black dark:text-white" size={14} />, name: "Next.js" },
    { icon: <SiTailwindcss className="text-cyan-400" size={14} />, name: "Tailwind" },
    ...
    <footer className="bg-gradient-to-br from-violet-700 to-indigo-800 text-white py-8 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="flex flex-col items-center">
          ...
          {/* Social links with refined tooltips */}
          <motion.div 
          ...
          >
            {socialLinks.map((social) => (
              ...
              >
                ...
                <div className="absolute -bottom-7 left-1/2 transform -translate-x-1/2 opacity-0 group-hover:opacity-100 transition-opacity duration-200 whitespace-nowrap text-xs bg-white/20 backdrop-blur-sm px-2 py-1 rounded-md shadow-sm">
                  {social.name}
