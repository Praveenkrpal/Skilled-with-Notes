  ...
  const originalNotes = [
    {
      ...
      description: "Learn modern HTML5 features including semantic elements, forms, multimedia, and APIs. Perfect for beginners and refreshers.",
      category: "HTML",
    ...
    },
    {
      ...
      description: "Deep dive into JavaScript programming language: variables, functions, objects, ES6+ features and DOM manipulation.",
      category: "JS",
    ...
    },
    {
      ...
      description: "Comprehensive guide to React hooks, components, state management, and best practices for building modern web apps.",
      category: "React",
    ...
    },
    {
      ...
      description: "Explore advanced C++ features like templates, STL, move semantics, and concurrency patterns.",
      category: "C++",
      image: "https://cdn-icons-png.flaticon.com/512/6132/6132222.png",
      level: "Advanced",
      duration: "6h",
    ...
    },
    {
      ...
      description: "Learn how TypeScript enhances JavaScript with types, interfaces, generics and advanced patterns.",
      category: "TypeScript",
    ...
    },
    {
      ...
      description: "Build scalable server-side applications with Node.js, Express, and modern JavaScript.",
      category: "Node.js",
    ...
    },
    {
      ...
      description: "Containerize your applications with Docker, learn about images, containers, and deployment strategies.",
      category: "Docker",
  ...
  useEffect(() => {
    ...
    switch(sortOption) {
      ...
      case "title-desc":
        ...
        break;
      case "recent":
        filteredNotes.sort((a, b) => new Date(b.lastUpdated) - new Date(a.lastUpdated));
        break;
      case "duration-asc":
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12 relative overflow-hidden rounded-xl bg-gradient-to-r from-indigo-500 to-purple-600 py-12 px-6 shadow-xl">
          ...
          <p className="text-lg text-indigo-100 max-w-3xl mx-auto relative z-10">
            Explore our comprehensive collection of programming notes, tutorials and resources to accelerate your learning journey
          </p>
        ...
        <div className="mb-10 bg-white rounded-2xl shadow-lg p-6 backdrop-blur-sm bg-white/70">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
            <div className="w-full md:w-auto">
              <h2 className="text-lg font-semibold text-gray-800 mb-3">Refine your search</h2>
              <div className="flex flex-wrap gap-3">
                ...
                {/* Course Filter */}
                <div className="relative">
                  <label htmlFor="course-filter" className="block text-xs font-medium text-gray-500 mb-1">
                    Course
                  </label>
                  <div className="relative">
                    <select
          ...
          {/* Active Filters */}
          {(selectedCategory !== "All" || selectedCourse !== "All" || selectedLevel !== "All" || searchTerm || sortOption !== "default") && (
              ...
              {sortOption !== "default" && (
                <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-amber-100 text-amber-800 shadow-sm">
                  Sorted: {
                    ...
                    sortOption === "recent" ? "Recently Updated" :
                    sortOption === "duration-asc" ? "Duration (Shortest)" :
                    "Duration (Longest)"
                  }
                  <button 
        ...
        <div className="mb-8 grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div className="bg-white rounded-xl shadow-md p-6 border-l-4 border-violet-500 hover:shadow-lg transition-shadow duration-300">
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-gray-800">{originalNotes.length}</p>
              </div>
            </div>
          </div>
          <div className="bg-white rounded-xl shadow-md p-6 border-l-4 border-blue-500 hover:shadow-lg transition-shadow duration-300">
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-gray-800">{courses.length - 1}</p>
              </div>
            </div>
          </div>
          <div className="bg-white rounded-xl shadow-md p-6 border-l-4 border-green-500 hover:shadow-lg transition-shadow duration-300">
            <div className="flex items-center">
              ...
              <div>
                <h3 className="text-sm font-medium text-gray-500">Filtered Notes</h3>
          ...
          <>
            {notes.length > 0 ? (
                  ...
                  >
                    ...
                    >
                      <div className="absolute inset-0 opacity-10">
                        <div className="absolute top-0 left-0 w-32 h-32 rounded-full filter blur-xl" style={{ backgroundColor: note.accentColor }}></div>
                        <div className="absolute bottom-0 right-0 w-32 h-32 rounded-full filter blur-xl" style={{ backgroundColor: note.accentColor }}></div>
                      </div>
                      <img
                        src={note.image}
                        alt={note.category}
                        className={`h-20 object-contain transition-all duration-500 ${isHovering === note.id ? 'scale-125' : 'scale-100'}`}
                        style={{ filter: isHovering === note.id ? 'drop-shadow(0 5px 15px rgba(0,0,0,0.3))' : 'none' }}
                      />
                    </div>
                    ...
                    <div className="p-5">
                      <div className="flex justify-between items-start mb-3">
                        ...
                        <span className={`text-xs font-medium px-2 py-1 rounded ${
                          note.level === 'Beginner' ? 'bg-green-100 text-green-800' :
                          note.level === 'Intermediate' ? 'bg-blue-100 text-blue-800' :
                      ...
                      <p className="text-gray-600 mb-3 line-clamp-2 text-sm">{note.description}</p>
                      <div className="mb-3">
                      ...
                      <div className="flex justify-between items-center text-sm text-gray-500">
                        ...
                        <span className="flex items-center">
                          ...
                          {new Date(note.lastUpdated).toLocaleDateString('en-US', { month: 'short', day: 'numeric', year: 'numeric' })}
                        </span>
                      </div>
                      <div className="flex items-center text-violet-600 font-medium group-hover:text-violet-800 transition-colors duration-200 mt-3">
                        View notes
                        <svg className={`w-4 h-4 ml-2 transition-transform duration-200 ${isHovering === note.id ? 'translate-x-1' : 'translate-x-0'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="text-center py-16 bg-white rounded-xl shadow-sm">
                ...
                <h3 className="mt-4 text-xl font-medium text-gray-900">No matching notes found</h3>
                <p className="mt-2 text-gray-500 max-w-md mx-auto">
                  We couldn't find any notes matching your criteria. Try adjusting your filters or search term.
                </p>
                <div className="mt-6">
                  <button
                    onClick={resetFilters}
